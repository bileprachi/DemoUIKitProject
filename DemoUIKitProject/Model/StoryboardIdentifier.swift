...
//  Description : This swift file contains all Storyboard Identifiers
...
class StoryboardIdentifier {
    ...
    static let labelVCIdentifier = "labelVCStoryboradID"
    static let pickerVCIdentifier = "pickerVCStroryboardID"
    static let buttonVCIdentifier = "buttonVCStoryboardID"
    static let stackViewVCIdentifier = "stackViewVCStoryboardID"
